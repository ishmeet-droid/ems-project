    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.kane.sol");
                servletContext.setInitParameter("tapestry.development-modules", "com.kane.sol.services.DevelopmentModule");
